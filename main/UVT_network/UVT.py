...
class HAB(nn.Module):
    ...
    def forward(self, x, x_size, rpi_sa, attn_mask):
        ...
        # conv_y=self.attny(x.permute(0, 3, 1, 2))
        # conv_y = conv_y.permute(0, 2, 3, 1).contiguous().view(b, h * w, c)
...
class HAT(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_first=DeformConv2d(num_in_ch,embed_dim,3,1,1)
...
model=HAT()
# macs, params = get_model_complexity_info(model, x, as_strings=True, print_per_layer_stat=True)
pretrained_weights=torch.load("/home/optical/Desktop/hat/experiments/lele/models/net_g_330000.pth")
print(pretrained_weights)
model.load_state_dict(pretrained_weights['params_ema'], strict=True)
# out=model(x)
# print("hello")
